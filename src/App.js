...
import {HowToReg, VpnKey, Timelapse, Favorite, AddShoppingCart} from '@material-ui/icons';
    ...
    <Router>
      <CssBaseLine/>
          <Header user={user}>
              ...
              {user && <Button to="/shoppinglist" component={MyLink} color="inherit"><AddShoppingCart /></Button>}
