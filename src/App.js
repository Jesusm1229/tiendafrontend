...
import {HowToReg, VpnKey, Timelapse, Favorite, ShoppingCartSharp} from '@material-ui/icons';
    ...
    <Router>
      <CssBaseLine/>
          <Header user={user}>
              ...
              {user && <Button to="/shoppingcart" component={MyLink} color="inherit"><ShoppingCartSharp /></Button>}
              {user && <Button to="/lastproducts" component={MyLink} color="inherit"><Timelapse /></Button>}
              {user && <Button to="/favorites" component={MyLink} color="inherit"><Favorite /></Button>}
